    ...
    public class CharmItem2Radius : ItemBase
    {
        ...
        protected override void ExecuteEffect(GridCell target)
        {
            ...
            if (statusSystem != null)
            {
                ...
                Debug.Log($"CharmItem2Radius.ExecuteEffect: Applied Charm to {affectedNPCs.Count} NPCs for {itemData.EffectDuration} turns (chosen NPC will walk toward target each turn)");
            }
            else
            {
